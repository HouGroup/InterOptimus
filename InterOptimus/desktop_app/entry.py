...
def _apply_portable_home(home: Path) -> None:
    ...
    _sess = str(home / ".interoptimus" / "web_sessions")
    os.environ.setdefault("INTEROPTIMUS_DESKTOP_SESSIONS", _sess)
    os.environ.setdefault("INTEROPTIMUS_WEB_SESSIONS", _sess)
