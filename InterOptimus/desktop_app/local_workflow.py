"""
Local ``simple_iomaker`` workflow for the Tk desktop GUI (and any caller that imports this module).

There is no separate HTTP server; sessions live on disk under :func:`sessions_root`.
"""
