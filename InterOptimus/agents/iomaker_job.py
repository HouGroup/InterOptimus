...
def execute_iomaker_pipeline(settings: Dict[str, Any], cfg: BaseBuildConfig, film_conv: Structure, substrate_conv: Structure, meta: Dict[str, Any], structures_info: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not settings.get('name') or settings.get('name') == 'IOMaker':
...
def execute_iomaker_from_settings(settings: Dict[str, Any], cfg: BaseBuildConfig) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        structures_info = {}
    return execute_iomaker_pipeline(settings, cfg, film_conv, substrate_conv, meta, structures_info)
